...
//			T.LookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default
		...
		public void init(GLAutoDrawable drawable) {
		    ...
		    float[] lightPosition = {2f, 2f, 5f, 1.0f};
			...
			// Set Sphere material
		    Vec4 materialAmbient1 = new Vec4(0.0f, 0.1f, 0.5f, 1.0f);
		    Vec4 materialDiffuse1 = new Vec4(0.0f, 0.7f, 0.0f, 1.0f);
		    Vec4 materialSpecular1 = new Vec4(1.0f, 1.0f, 0.0f, 1.0f);
			...
			SObject cylinder = new SCylinder(2f, 1f, 40);
			idPoint=1;
			idBuffer=1;
			idElement=1;
			...
			// Set Sphere material
			Vec4 materialAmbient2 = new Vec4(0.1f, 0.0f, 0.5f, 1.0f);
			Vec4 materialDiffuse2 = new Vec4(0.7f, 0.0f, 0.0f, 1.0f);
			Vec4 materialSpecular2 = new Vec4(1.0f, 1.0f, 0.0f, 1.0f);
