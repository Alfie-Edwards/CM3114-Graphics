...
public class CGCW01 extends JFrame{
	...
	class Renderer implements GLEventListener, KeyListener{
		...
		private static final float ZOOM_SPEED = 1.1f;
		private static final float TRANSLATION_SPEED = 0.25f;
		private static final float ROTATION_SPEED = 360 / 24f;
...
//		    gl.glDepthFunc(GL_LESS);
		...
		public void keyPressed(KeyEvent ke) {
			...
			case KeyEvent.VK_LEFT:
				yaw = (yaw - ROTATION_SPEED) % 360; // mod 360 stops numbers from reaching extreme values
				break;
			...
			// Rotation (pitch)
			case KeyEvent.VK_UP:
				pitch = (pitch - ROTATION_SPEED) % 360;
				break;
